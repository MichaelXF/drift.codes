...
const lightThemeOptions = {
  typography: {
    fontFamily: `"Mono Sans", system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif`, // Set the default font family to Fire Sans
    code: {
  ...
  palette: {
    ...
    divider: "rgba(18, 19, 20, 0.1)",
    divider_opaque: "rgb(120, 125, 130)",
...
export const darkTheme = createTheme(
  deepmerge(lightThemeOptions, darkThemeOptions)
);
